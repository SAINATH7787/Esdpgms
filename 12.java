//implement booths multiplier
class boothsAlgo {
	static int size = 4;
	int multiplicand[] = new int[]{1, 1, 0, 1}; // -5 in 2s complement
	int multiplier[] = new int[]{0,1,0,0,1}; // -7 in 2s complement
	int a[]= new int[size];
